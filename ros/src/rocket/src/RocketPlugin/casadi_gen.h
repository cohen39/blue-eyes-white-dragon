...
int rocket_force_moment(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int rocket_force_moment_alloc_mem(void);
int rocket_force_moment_init_mem(int mem);
void rocket_force_moment_free_mem(int mem);
int rocket_force_moment_checkout(void);
void rocket_force_moment_release(int mem);
...
casadi_real rocket_force_moment_default_in(casadi_int i);
...
int pitch_control(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int pitch_control_alloc_mem(void);
int pitch_control_init_mem(int mem);
void pitch_control_free_mem(int mem);
int pitch_control_checkout(void);
void pitch_control_release(int mem);
void pitch_control_incref(void);
void pitch_control_decref(void);
casadi_int pitch_control_n_out(void);
casadi_int pitch_control_n_in(void);
casadi_real pitch_control_default_in(casadi_int i);
const char* pitch_control_name_in(casadi_int i);
const char* pitch_control_name_out(casadi_int i);
const casadi_int* pitch_control_sparsity_in(casadi_int i);
const casadi_int* pitch_control_sparsity_out(casadi_int i);
int pitch_control_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
casadi_functions* pitch_control_functions(void);
int rocket_u_to_fin(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int rocket_u_to_fin_alloc_mem(void);
int rocket_u_to_fin_init_mem(int mem);
void rocket_u_to_fin_free_mem(int mem);
int rocket_u_to_fin_checkout(void);
void rocket_u_to_fin_release(int mem);
...
casadi_real rocket_u_to_fin_default_in(casadi_int i);
